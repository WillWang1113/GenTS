...
from ._backbones import RATD_Forecasting


class RATD(BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model = RATD_Forecasting(config, seq_dim)
        self.encoder = TCN(seq_len, seq_dim, tcn_d_models + [seq_dim])
    ...
    def pretrain_encoder(self, dataloader):
        optim = torch.optim.Adam(self.encoder.parameters())
