...
def prep_data(
    data, covariates, data_start, num_covariates, train=False, valid=False, test=False
):
    ...
    for series in trange(num_series):
        ...
        for i in range(windows_per_series[series]):
            ...
            # [bs, obs+pred len, 1(univariate) + num_covariates + 1(chnl_id)]
            ...
            if nonzero_sum == 0:
                ...
                x_input[count, 1:, 0] = (
                    x_input[count, 1:, 0] - v_input[count, 1]
                ) / v_input[count, 0]
                if train:
                    label[count, :] = (label[count, :] - v_input[count, 1]) / v_input[
                        count, 0
                    ]
            assert v_input[count, 1] == 0.0
            count += 1
...
if __name__ == "__main__":
    ...
    csv_path = "/home/user/workspaces/GenTS/data/elec/LD2011_2014.txt"
